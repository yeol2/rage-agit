...
export const siteConfig = {
  ...
  memberDirectory: {
    ...
    hexagon: {
      heading: '6각형 지표',
      lines: [
        '최근 10경기를 여섯 축으로 나눈 그림입니다. 축에 마우스를 올리면 실제 값이 나옵니다.',
        '점선은 같은 티어 그룹의 자리입니다. 높은 티어 그룹일수록 점선이 크고, 실선이 점선 바깥이면 그룹 평균보다 잘한 축입니다.',
        '딜량·생존·어시는 2026년 6월 7일 경기부터 남아 있습니다. 그전 내전은 결과 스크린샷뿐이라 킬과 등수밖에 없어 이 그림에 들어가지 못합니다.',
      ],
    },
  },
