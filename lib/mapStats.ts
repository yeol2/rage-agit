...
//
// 재료는 member_map_stats 뷰(0041)가 만든다. 여기서는 순서만 정한다.
//
// 자격선을 걸지 않는다. 뛴 맵은 전부 보여주고 경기 수를 같이 적는다 — 맵당
// 4경기짜리 평균은 오차가 ±2.35등이라 그 자체로는 실력을 말하지 못하는데,
// 그 사실을 숨기는 것보다 경기 수를 옆에 적어 읽는 사람이 감안하게 하는 편이
// 정직하다.
